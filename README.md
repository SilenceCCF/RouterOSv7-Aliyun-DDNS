...
- dingtalk.txt 为发送钉钉消息脚本。
- wecom.txt 为发送企业微信消息脚本。
- aliyun-ddns.php 为 PHP 转发代理。

更新：
- 2026年9月9日。修正 PPP_Profile_OnUp.txt 脚本中误将域名变量名 Domain 写错导致主脚本找不到域名的错误。
- 2026年9月7日。删除 PPP_Profile_OnUp.txt 脚本中域名、接口及运营商的映射关系语句，改为由在接口的 PPP_Profile_OnUp.txt 脚本中定义，然后由参数传入。
- 2026年9月6日。因为较新版本的 RouterOS V7（大概是 7.23 左右）增强了安全策略，接口的 On Up 事件脚本中使用 execute 命令受限，故更新了调用方式。另外增加了企业微信机器人发送消息方式，增加了设备位置变量。
- 2025年8月20日第一版。
